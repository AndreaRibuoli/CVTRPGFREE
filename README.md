...
================================================================================
1.5.10    14/09/2023   
* FIX: Comments of 1 character causes a crash (ticket #49).
* FIX: EXTNAME must be first keyword on DS declaration (ticket #51).
* FIX: Definitions using adjustments don't convert properly (ticket #52).
* FIX: Statements with ER indicator which convert to BIFs must be wrapped in a
       MONITOR structure (ticket #53).
* FIX: Name value in EXTFL must be quoted (ticket #55).
* FIX: Quoted EXTNAME value causes a hang (ticket #56).
* FIX: CAT with varying length field not converted properly (ticket #58).
* FIX: Compile time entries getting corrupted (tickets #59 and #60).
* FIX: Conversion adds a spurious line to the source (ticket #61).
* FIX: Auto Data Area structures not converted correctly (ticket #62).

================================================================================
Change Log
================================================================================
1.5.09    04/06/2023   
* FIX: Correctly update the missing source in V1.5.08.

================================================================================
1.5.08    31/05/2023   
* NEW: Added parameter to specify the number of days to retain mod-markers.
       Zero = retain all existing mod-markers.
	   Non-zero, mod-markers on lines changed prior to the retention period will
	   be removed.
* FIX: CAT opcodes specifying colons in a literal in factor2 now convert 
       properly.
* FIX: CLEAR opcode with *NOKEY is now converted correctly.	   

================================================================================
1.5.07    24/12/2022   
* FIX: Minor tweak to indentation when parsing a source file with existing
       free-format declarations.
================================================================================
1.5.06    29/10/2022   
